...
*/
	...
	#define SPI_MISO  0
	#define SPI_CLOCK 5
	#define SPI_MOSI  4 //< Was 3 //DI.
	#define SPI_CS    1 //< Was 4.
	#define SD_EJECT  3 //< Was 1.
	#define SPI_DDR   DDRD
	#define SPI_PIN   PIND
	#define SPI_PORT  PORTD
	#define _CLK_DI_CS	0b00110010 //< Was 0b00111000.
	#define _CLKNDI_CS	0b00100010 //< Was 0b00110000.
	#define NCLK_DI_CS	0b00010010 //< Was 0b00011000.
	#define NCLKNDI_CS	0b00000010 //< Was 0b00010000.
	#define _CLK_DINCS	0b00110000 //< Was 0b00101000.
	#define _CLKNDINCS	0b00100000
	#define NCLK_DINCS	0b00010000 //< Was 0b00001000.
	#define NCLKNDINCS	0b00000000

	// SD LED
	#define SD_LED_PORT PORTB
	#define SD_LED_PORTD DDRB
	#define SD_LED 4 // Was 5.
